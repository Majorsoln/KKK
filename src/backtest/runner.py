    ...
    *,
    ...
    for leg in sorted(basket.legs, key=lambda l: l.symbol):
        ...
        kusanya.append(Trade(
            ...
            entry_at=basket.entry_at, exit_at=basket.planned_exit_at,
            entry_price=bei_ndani, exit_price=bei_nje,
            ...
            spread_realised_pips=gross - utekelezaji,
...
__all__ = ["PARTIAL_EXECUTION", "ExecuteError", "Trade", "Execution",
           "execute", "execute_all"]
